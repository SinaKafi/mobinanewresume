...
//         <h1 className="text-2xl font-medium text-gray2">Wellowork Website </h1>
...
//           portfolio:
//           <br />
//           Landing Page Design for Employee Wellness App As part of the Employee
//           Wellness App project, I was tasked with designing a landing page that
//           effectively communicated the app's core features, value proposition,
//           and the key stakeholders involved in the project. The goal was to
//           provide visitors with a concise yet engaging overview of the app while
//           establishing credibility and trust with potential users, investors,
//           and stakeholders.
//         </p>
//         <p className="leading-7 text-lg whitespace-normal text-justify font-light">
...
//                 glance. I used engaging visuals and clear typography to break
//                 down information and make it digestible without overwhelming the
//                 user.
//               </p>{" "}
//             </li>
//             <li>
...
//                 navigate. The layout included interactive elements such as
//                 sliding carousels for testimonials, quick links to app features,
//                 and sections for getting started. The goal was to engage users
...
//               </span>
//               <p className="pl-3 leading-7 text-lg whitespace-normal text-justify font-light">
//                 A critical element of the landing page was showcasing the
//                 managers and stakeholders behind the project. This section
//                 helped build credibility and trust by introducing the
//                 individuals who were instrumental in the app’s development. I
//                 designed professional portraits alongside their roles and
//                 contributions, adding a personal touch and making the project
...
//               </span>
//               <p className="pl-3 leading-7 text-lg whitespace-normal text-justify font-light">
//                 A prominent call to action was strategically placed throughout
//                 the page, urging visitors to download the app or contact the
//                 team for more information. These CTAs were designed to be
//                 visually appealing, with action-oriented copy that encouraged
...
//                 colors and simple, modern design elements to evoke a sense of
//                 calm and wellness. The overall aesthetic was minimalistic,
//                 ensuring that the message of health and well-being was the focal
//                 point.
//               </p>{" "}
//             </li>
//           </ol>
...
function Page() {
  return (
    <div className="flex flex-col justify-between space-y-8">
      ...
      <div className="flex flex-col gap-8">
        <h1 className="text-2xl font-medium text-gray2">Wellowork Website</h1>
        <p className="leading-relaxed text-lg text-justify font-light">
          Here’s a description for the landing page you designed for the
          employee wellness app, which you can use in your product design
          portfolio.
        </p>
        ...
        <div className="flex flex-col">
          <ol className="list-decimal marker:font-normal list-inside space-y-8">
            <li>
              <span className="pl-2 leading-relaxed text-lg text-justify text-lg font-medium text-gray2 font-light">
                Core Features Overview:
              </span>
              <p className="pl-3 leading-relaxed text-lg text-justify font-light">
                The landing page succinctly highlighted the app’s key
                features—such as mental health support, physical health
                management, and stress-relief activities. Each feature was
                presented with intuitive icons and short descriptions to ensure
