          ...
          <li>
            ...
            <li>
              ...
              <p className="designTitle mb-2">
                ...
                experience for users to browse, select, and purchase their
                desired Toyota vehicle with minimal friction.
              </p>
              <div className="pl-4 md:pl-8">
                <ul className="list-disc list-outside space-y-2">
                  <li>
                    ...
                    <p className="designTitle">
                      We created detailed user journey maps to visualize the
                      steps a customer would take from browsing cars to
                      completing a purchase. This helped us identify key
                      touchpoints and optimize them for simplicity.
                    </p>
                  </li>
                  <li>
                    <span className="designTitleBold">
                    ...
                    <p className="designTitle">
                      ...
                      page, focusing on clear calls-to-action (CTAs) like “Add
                      to Cart” and “Request a Quote.” We also created prototypes
                      to test the flow of the website before moving into the
                      visual design phase.
                    </p>
                  </li>
                  <li>
                    ...
                    <p className="designTitle">
                      Considering the high usage of mobile devices, we
                      prioritized a mobile-first approach to ensure the website
                      was fully responsive and provided a great experience
              ...
              <div className="pl-4 md:pl-8">
                <ul className="list-disc list-outside space-y-2">
                  ...
                  <li>
                    ...
                    <p className="designTitle">
                      The design incorporated clean, easy-to-read typography,
                      and strategically placed images of vehicles. Buttons were
                      clearly visible to guide users through the purchase
                      journey smoothly.
                    </p>
                  </li>
                </ul>
                ...
                <ul className="list-disc list-outside space-y-2">
                  <li>
                    ...
                    <p className="designTitle">
                      ...
                      system was built to handle personal data securely and
                  ...
                  <li>
                    ...
                    <p className="designTitle">
                      Prior to launch, the site was rigorously tested to ensure
                      it worked seamlessly across all devices and browsers. We
                      paid close attention to optimizing loading times and
                      enhancing site speed, especially for mobile users.
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <li>
              ...
              <p className="designTitle mb-2">
                After the website was launched, we monitored its performance
                using analytics tools to track user behavior. We also collected
                feedback from customers to identify areas for improvement and
                refine the site over time.
              </p>
            </li>
          </li>
        </ol>
